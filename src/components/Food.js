            ...
            <div className='flex flex-col lg:flex-row justify-between'>
                ...
                <div>
                    ...
                    <div className='flex justify-between max-w-[390px] w-full' >
                        ...
                        <button onClick={()=>filterPrice('$$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$$</button>
                        <button onClick={()=>filterPrice('$$$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>SSS</button>
                        <button onClick={()=>filterPrice('$$$$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>$$$$</button>
                    </div>
                </div>
            </div>
                ...
                {foods.map((item, index) => {
                    ...
                    return (
                        <div className='border shadow-lg rounded-lg hover:scale-105 duration-300' key={index}>
                            <img className='w-full h-[200px] object-cover rounded-t-lg' src={image} alt="" />
                            <div className='flex justify-between px-2 py-4'>
                                <p className='font-bold'>{name}</p>
                                <p><span className='bg-orange-500 p-1 text-white rounded-full'>{price}</span></p>
                            </div>
                        </div>
                    )
                })}
